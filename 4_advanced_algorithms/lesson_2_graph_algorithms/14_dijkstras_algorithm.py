...
'''
In this exercise, you'll implement Dijkstra's algorithm.
First, let's build the graph.
'''

# Graph Representation
'''
In order to run Dijkstra's Algorithm, we'll need to add distance
to each edge. We'll use the GraphEdge class below to represent
each edge between a node.
'''
...
# Implementation
'''
Using what you've learned, implement Dijkstra's Algorithm to find
the shortest distance from the "U" node to the "Y" node.
'''
